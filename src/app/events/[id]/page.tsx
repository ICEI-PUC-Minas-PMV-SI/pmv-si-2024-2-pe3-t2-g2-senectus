...
const eventsData = [
  {
    ...
    subtitle: "Atividades ao ar livre com caminhada leve e exercícios de alongamento para manter a mobilidade.",
  ...
  },
  {
    ...
    subtitle: "Aula de pilates adaptado para fortalecer músculos e melhorar a flexibilidade.",
  ...
  },
  {
    ...
    subtitle: "Uma sessão divertida de dança de baixo impacto para socializar e manter-se ativo.",
  ...
  },
  {
    ...
    subtitle: "Ensinando a montar refeições nutritivas para saúde e energia diárias.",
  ...
  },
  {
    ...
    subtitle: "Dicas práticas para cuidar do coração na terceira idade e prevenir doenças.",
            ...
            <ContentSection>
              ...
              <Sidebar>
                ...
                <Card>
                  ...
                  <p><strong>Criado em:</strong> {event.createdAt}</p>
                  <div className="separator"></div>
                  <p><strong>Início:</strong> {event.startDate}</p>
                  <p><strong>Término:</strong> {event.endDate}</p>
                </Card>
