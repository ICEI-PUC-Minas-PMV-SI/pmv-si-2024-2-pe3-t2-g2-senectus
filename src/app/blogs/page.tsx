...
const posts = [
  {
    ...
    description:
      'Exercícios físicos podem reduzir hospitalizações e promover o envelhecimento saudável.',
  ...
  },
  {
    ...
    description:
      'Entenda os benefícios de caminhadas leves para manter a saúde cardiovascular.',
  ...
  },
  {
    ...
    description:
      'Sugestões de atividades simples para promover mobilidade e bem-estar.',
  ...
  },
  {
    ...
    description:
      'Saiba como exames preventivos ajudam a garantir uma vida mais saudável.',
  ...
  },
  {
    ...
    description:
      'Descubra como uma alimentação equilibrada pode melhorar a qualidade de vida na terceira idade.',
            ...
            {posts.map((post) => (
              <EventItemContainer key={post.id} href={`/blogs/${post.id}`}>
                <EventInfo>
                  ...
                  <p className="title" style={{ color: '#007BFF' }}>
                    {post.title}
                  </p>
