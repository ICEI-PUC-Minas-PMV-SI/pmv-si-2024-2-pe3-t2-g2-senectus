import { PostSignUpFormProps } from '@components/postsignup/AppFormPostSignUp'
...
type PostSignUpFormPropsReturn = PostSignUpFormProps & { isError?: boolean }

export class ValidateFormService {
  static exec(objt: PostSignUpFormProps): PostSignUpFormPropsReturn {
